      ...
      <div className="pt-5 pb-6 flex flex-col gap-4">
        <div>
          ...
          <p className="text-xs mt-1" style={{ color: 'var(--color-subtext)' }}>
            {hasStarted
              ? translate(t.towerTargetInstruction, { floors: TARGET_FLOORS })
              : translate(t.towerStartInstruction, { floors: TARGET_FLOORS })}
          </p>
        </div>
        ...
        <Card className="rounded-2xl p-4">
          <p className="text-sm font-bold" style={{ color: 'var(--color-text)' }}>
            {t.towerHowToWinTitle}
          </p>
          <p className="text-xs mt-1" style={{ color: 'var(--color-subtext)', lineHeight: '1.6' }}>
            {translate(t.towerHowToWinDesc, { floors: TARGET_FLOORS })}
          </p>
        </Card>
      ...
      <Popup open={showWin} onClose={() => {}} showClose={false}>
        <div className="flex flex-col items-center gap-4 text-center">
          <CheckpointWinReward
            ...
            title={t.towerWinTitle}
            message={t.towerWinMessage}
          />
