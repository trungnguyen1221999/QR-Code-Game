...
function getCheckpointRoute(checkpoint) {
  ...
  if (checkpoint === 1) return '/puzzle-game';
  if (checkpoint === 2) return '/simon-game';
  if (checkpoint === 3) return '/whack-a-mole';
  if (checkpoint === 4) return '/combined-word-quiz';
  if (checkpoint === 5) return '/memory-game';
  if (checkpoint === 6) return '/tower-builder';
